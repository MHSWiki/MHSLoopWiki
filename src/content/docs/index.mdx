...
| **Best Bike** | **Honda ADV 160** (Solo) or **Honda CB500X** (Pro/Two-up). |
...
<LinkCard 
    title="Ready to go? Download the GPX Files" 
    description="Don't rely on spotty 4G in the mountains. Get the offline maps." 
    href="/route/map" 
/>
